<script>
	...
	let isBottomBarExpanded = false;
	let currentView = 'home';
	let detailsPosition = 'left';
	...
	$: bottomBarHeight = isBottomBarExpanded ? '200px' : '60px';
</script>
	...
	<div class="right-section" style="--bottom-bar-height: {bottomBarHeight}">
		...
		<div class="content" onclick={() => (selectedItem = null)}>
			{#if currentView === 'home'}
				...
				<p>
					...
					vel, egestas et, augue. Vestibulum tincidunt malesuada tellus. Ut ultrices ultrices enim.
		...
		<div class="bottom-bar">
			<div class="top-row">
				...
				<button onclick={() => (isBottomBarExpanded = !isBottomBarExpanded)} class="button">
